...
class ProgressServiceTest {
        ...
        void testGetConsolidatedProgress_AllDataAvailable() {
                ...
                when(profileRepository.findFirstByAuthUserId(authId)).thenReturn(Optional.of(p));
                ...
                when(assessmentClient.getSkillMastery(userId)).thenReturn(List.of(
                                ...
                                Map.of("skillId", UUID.randomUUID().toString(), "skillName", "Spring", "mastery",
                                                0.5)));
        ...
        void testGetConsolidatedProgress_ProfileNotFound_Throws() {
                when(profileRepository.findFirstByAuthUserId("unknown")).thenReturn(Optional.empty());
